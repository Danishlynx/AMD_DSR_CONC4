...
This campaign used **two different measurement regimes**. Per-lever ΔTPOT values from the two regimes are NOT directly comparable.
...
**The authoritative final TPOT (5.641 ms) and the per-lever ΔTPOT values for L0-v2 and Phase 11 v3 below are all from the official kimbochen N=3 harness.**
...
| Metric | L0-v2 baseline | This submission (Phase 11 v3) | Δ |
|---|---:|---:|---:|
...
| # | Lever | Type | TPOT before | TPOT after | TPOT Δ | Measured |
|---|---|---|---:|---:|---:|---|
...
Apr 14–26: these env flags / CLI configs were turned ON during the informal-bench era of the campaign. Per-lever ΔTPOTs below are from the informal bench at the time and **are NOT directly comparable to the official kimbochen N=3 numbers above**.
...
- Their per-lever ΔTPOTs were measured under the informal bench (different `--random-range-ratio`, fewer warmups, different harness mechanics)
