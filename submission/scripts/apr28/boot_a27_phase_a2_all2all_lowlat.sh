#!/bin/bash
# Phase A2 sub-test 2: --all2all-backend low-latency (MORI AsyncLL kernel overlap for MoE)
LOGFILE=/tmp/a27_phase_a2_all2all_lowlat_$(date +%H%M%S).log
